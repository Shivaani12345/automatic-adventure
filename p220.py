...
def semantic_lidar_data1(point_cloud_data):
    ...
    for detection in point_cloud_data:
        ...
        if distance_name_data["name"]  == distance_name_data['distance'] > 3 and  distance_name_data['distance'] < 8
...
try:
    ...
    police_car_blueprint = get_blueprint_of_world.filter('police car')[0]
    ...
    police_car.apply_control(carla.VehicleControl(throttle=0.3))
